...
def visualize_masked_digits(output_dir: Path, num_samples: int = 16, grid_size: int = 6, mask_prob: float = 0.2):
    """
    ...
    """
    print("Loading data...")
    X = load_all_digits_data(dataset_path="data/mnist_2d_full_dataset.npz", max_samples=None, seed=42)
...
def main():
    ...
    visualize_masked_digits(output_dir, num_samples=num_samples, 
                           grid_size=grid_size, mask_prob=mask_prob)
